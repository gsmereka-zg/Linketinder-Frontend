...
form.addEventListener("submit", e => {
    ...
    const state = document.getElementById("cand-state").value.trim();
    const cep = document.getElementById("cand-cep").value.trim();
    const description = document.getElementById("cand-description").value.trim();
